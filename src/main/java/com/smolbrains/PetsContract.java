...
public class PetsContract extends Contract {
  ...
  @Deprecated
  public static PetsContract load(
      String contractAddress,
      Web3j web3j,
      Credentials credentials,
      BigInteger gasPrice,
      BigInteger gasLimit) {
    return new PetsContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
  }
  ...
  public static PetsContract load(
      ...
      BigInteger gasPrice,
      BigInteger gasLimit) {
    return new PetsContract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
  }
  ...
  public static PetsContract load(
      ...
      Credentials credentials,
      ContractGasProvider contractGasProvider) {
    return new PetsContract(contractAddress, web3j, credentials, contractGasProvider);
  }
  ...
  public static PetsContract load(
      ...
      TransactionManager transactionManager,
      ContractGasProvider contractGasProvider) {
    return new PetsContract(contractAddress, web3j, transactionManager, contractGasProvider);
  }
