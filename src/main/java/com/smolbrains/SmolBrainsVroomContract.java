...
public class SmolBrainsVroomContract extends Contract {
  public static final String BINARY = "Bin file was not provided";

  public static final String FUNC_DEFAULT_ADMIN_ROLE = "DEFAULT_ADMIN_ROLE";

  public static final String FUNC_SMOLCAR_MINTER_ROLE = "SMOLCAR_MINTER_ROLE";

  public static final String FUNC_SMOLCAR_OWNER_ROLE = "SMOLCAR_OWNER_ROLE";
  ...
  public static final Event SMOLCARMINT_EVENT =
      new Event(
          "SmolCarMint",
          Arrays.<TypeReference<?>>asList(
              new TypeReference<Address>(true) {},
  ...
  @Deprecated
  protected SmolBrainsVroomContract(
  ...
  public List<SmolCarMintEventResponse> getSmolCarMintEvents(
      TransactionReceipt transactionReceipt) {
    List<Contract.EventValuesWithLog> valueList =
        extractEventParametersWithLog(SMOLCARMINT_EVENT, transactionReceipt);
    ArrayList<SmolCarMintEventResponse> responses =
        new ArrayList<SmolCarMintEventResponse>(valueList.size());
    for (Contract.EventValuesWithLog eventValues : valueList) {
      SmolCarMintEventResponse typedResponse = new SmolCarMintEventResponse();
      typedResponse.log = eventValues.getLog();
  ...
  public Flowable<SmolCarMintEventResponse> smolCarMintEventFlowable(EthFilter filter) {
    return web3j
        .ethLogFlowable(filter)
        .map(
            new Function<Log, SmolCarMintEventResponse>() {
              @Override
              public SmolCarMintEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues =
                    extractEventParametersWithLog(SMOLCARMINT_EVENT, log);
                SmolCarMintEventResponse typedResponse = new SmolCarMintEventResponse();
                typedResponse.log = log;
                typedResponse.to = (String) eventValues.getIndexedValues().get(0).getValue();
                typedResponse.tokenId =
  ...
  public Flowable<SmolCarMintEventResponse> smolCarMintEventFlowable(
      DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
    filter.addSingleTopic(EventEncoder.encode(SMOLCARMINT_EVENT));
    return smolCarMintEventFlowable(filter);
  }
  ...
  public RemoteFunctionCall<byte[]> SMOLCAR_MINTER_ROLE() {
    final org.web3j.abi.datatypes.Function function =
        new org.web3j.abi.datatypes.Function(
            FUNC_SMOLCAR_MINTER_ROLE,
            Arrays.<Type>asList(),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
    return executeRemoteCallSingleValueReturn(function, byte[].class);
  }

  public RemoteFunctionCall<byte[]> SMOLCAR_OWNER_ROLE() {
    final org.web3j.abi.datatypes.Function function =
        new org.web3j.abi.datatypes.Function(
            FUNC_SMOLCAR_OWNER_ROLE,
            Arrays.<Type>asList(),
            Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {}));
    return executeRemoteCallSingleValueReturn(function, byte[].class);
  }
  ...
  @Deprecated
  public static SmolBrainsVroomContract load(
      String contractAddress,
      Web3j web3j,
      Credentials credentials,
      BigInteger gasPrice,
      BigInteger gasLimit) {
    return new SmolBrainsVroomContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
  }
  ...
  public static SmolBrainsVroomContract load(
      ...
      BigInteger gasPrice,
      BigInteger gasLimit) {
    return new SmolBrainsVroomContract(
  ...
  public static SmolBrainsVroomContract load(
      ...
      Credentials credentials,
      ContractGasProvider contractGasProvider) {
    return new SmolBrainsVroomContract(contractAddress, web3j, credentials, contractGasProvider);
  }
  ...
  public static class SmolCarMintEventResponse extends BaseEventResponse {
    public String to;
